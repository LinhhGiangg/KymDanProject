...
insert into kymdan.loai_san_pham (ma, ten, hinh1, hinh2, hinh3, mo_ta, luot_xem, ngay_tao) values ('KD-666', 'Nệm (mattress) KYMDAN Premium', 'assets/sanPham1.jpg', 'assets/sanPham6.jpg', 'assets/sanPham7.jpg', 'Hỗ trợ thêm 3 vùng trọng điểm của cơ thể,Lõi nệm kháng khuẩn,Lớp Memory Foam có độ bền cao', 200, '2021-08-11');
insert into kymdan.loai_san_pham (ma, ten, hinh1, hinh2, hinh3, mo_ta, luot_xem, ngay_tao) values ('KD-777', 'Nệm (mattress) KYMDAN Royal', 'assets/sanPham5.jpg', 'assets/sanPham6.jpg', 'assets/sanPham7.jpg', 'Hỗ trợ thêm 3 vùng trọng điểm của cơ thể,Chống dị ứng,Lớp Memory Foam có độ bền cao', 300, '2021-08-11');
