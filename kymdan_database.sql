...
insert into kymdan.chi_tiet_gio_hang(so_luong, ma_gio_hang, ma_san_pham) values (3, 1, 'SP-001');
insert into kymdan.chi_tiet_gio_hang(so_luong, ma_gio_hang, ma_san_pham) values (1, 1, 'SP-025');
